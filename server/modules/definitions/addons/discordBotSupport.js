...
global.logsChannel = "1159113358293864510"; // the channel ID of the dev logs
global.chatChannel = "1159113927918104606"; // the channel ID of your ingame chat
global.botsChannel = "1208170054831710298"; // the channel ID of your bot commands channel
global.devRole = "1159113491500773416"; // the ID of the developer role
global.muteRole = "0"; // the ID of the muted role
global.ownerRole = "771853593719341066"; // the ID of the server owner role
global.memberRole = "1160323684985221252"; // the ID of the basic member role
